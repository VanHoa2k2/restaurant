    ...
    <header className="fixed z-50 w-screen p-3 px-4 md:p-6 md:px-16 bg-primary">
      ...
      <div className="hidden md:flex w-full h-full items-center justify-between">
        ...
        <div className="flex items-center">
          ...
          <div
            className="relative flex rounded-md mx-6 cursor-pointer items-center justify-center"
            onClick={showCart}
          >
          ...
          <div className="relative">
            ...
            {isMenu && (
              ...
              >
                {user && user.email === "hoab2017041@student.ctu.edu.vn" && (
                  <Link to="/createItem">
                    <p
                      className="px-4 py-2 flex items-center gap-3 cursor-pointer hover:bg-slate-100 transition-all duration-100 ease-in-out text-textColor text-base rounded-t-lg"
                      onClick={() => setIsMenu(false)}
                    >
                      New Item <MdAdd />
                    </p>
        ...
        <div className="relative">
          ...
          {isMenu && (
            ...
            >
              ...
              <p
                className="m-2 p-2 rounded shadow-md flex items-center justify-center bg-gray-200 gap-3 cursor-pointer hover:bg-gray-300 transition-all duration-100 ease-in-out text-textColor text-base"
                onClick={logout}
              >
                Logout <MdLogout />
              </p>
